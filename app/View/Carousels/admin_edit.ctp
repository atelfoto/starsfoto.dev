...
<div class="page-header">
	<h2><?php echo __('Edit Carousel'); ?></h2>
</div>
<div class="container">
<div class="col-md-9 ">
	<div class="panel panel-info  box-home">
		<div class="panel-heading pane-title text-right">
			<?php echo $this->Html->link('<i class="fa fa-check-circle fa-lg "></i>&nbsp;&nbsp;'.__('close'),
					 		array('action' => 'index'), array("title"=>__("close"),'escape' => false)); ?>
		</div>
