...
<div class="index col-md-12" id="contentCarousel">
	...
	<div class="text-right" style='margin-bottom:10px;'>
		<button class="btn btn-default" data-toggle="modal" data-target="#ModalAide"><i class="icon-help-circled">&nbsp;<?= __('Help') ?></i></button>
		<?php echo $this->Html->link("<i class='icon-plus'></i>". __("New picture"),array('action'=>'add'),
			...
			<tbody>
				<?php foreach ($carousels as $carousel): ?>
					<tr>
						...
						<td><?php echo $this->Time->format($carousel['Carousel']['created'],'%a %e %B %Y'); ?>&nbsp;</td>
						<td><?php echo  $this->Time->format($carousel['Carousel']['modified'],'%a %e %B %Y'); ?>&nbsp;</td>
						<td><?php if($carousel['Carousel'][ 'class' ] === "active") {
							echo $this->Html->tag('span', "", array('class' => "icon-star","style"=>"font-size: 18px; color: rgb(240, 173, 78)"));
							}else{
							echo $this->Html->link('<span class="icon-star-empty" style="font-size: 18px; color: rgb(230, 230, 230)"></span>',
						...
						<td>
							<?php echo $this->Html->link('<span class="icon-picture" style="color:#00f;"></span>',
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="icon-pencil" style="color:#00f;"></span>',
						...
						<td>
							...
							<?php echo $this->Html->link('<span class="icon-trash" style="color:#f00;"></span>',$carousel['Carousel']['id'],
