<?php echo $this->assign('title', __('pages')); ?>
 <?php $this->Html->addCrumb(__('pages')); ?>
 <div class="posts index row">
	<div class="col-md-12 page-header">
		<h2><i class="icon-posts"></i>&nbsp;<?php echo __('Pages'); ?></h2>
	</div>
	<div class="col-md-12">
			...
			<table  class="table table-bordered text-center table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td> <?php echo $this->Time->format($v['created'], "%A %e %B ,%Y"); ?></td>
						<td> <?php echo $this->Time->format( $v['modified'] , "%A %e %B , %Y"); ?></td>
						<td><?php echo h($v['modified_by']); ?>&nbsp;</td>
						<td><?php if($v[ 'online' ] == 0) {
						echo $this->Html->link('<span class="label label-danger"><i class="icon-cancel-circled">'.__('Offline').'</i></span>',
						array('action'=>'enable', $v['id']),
					...
					?>
					 ...
					 array('action' => 'view', $v['id']),
					 array('class'=>'btn btn-default','escape' => false,
					 'data-title'=>__('view').' '.$v['name'],'data-toggle'=>'tooltip','data-placement'=>'bottom')); ?>
						</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="icon-pencil"></span>',
					 array('action' => 'edit',$v['id'] ),
					 array('class'=>'btn btn-default','escape' => false,
					  'data-title'=>__('edit').' '.$v['name'],'data-toggle'=>'tooltip','data-placement'=>'bottom')); ?>
						</td>
						<td class="actions">
							<p data-placement='bottom' data-toggle='tooltip' title='<?= __('delete').' '.$v['name'];?>' class='text-center'>
							<?php echo $this->Html->link('<span class="icon-trash"></span>','#delete'.$v['id'],
...
<?php foreach ($pages  as $k => $v): $v = current($v);?><!-- modal supprimer -->
