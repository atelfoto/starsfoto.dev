<?php echo $this->assign('title', __('Helps')); ?>
 ...
 <div class="helps index row">
	<div class="col-md-12 page-header">
		<h2><i class="icon-helps"></i>&nbsp;<?php echo __('Helps'); ?></h2>
	</div>
	<div class="col-md-12">
			...
			<table  class="table table-bordered text-center table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td style="text-transform:none"><a href="<?php echo $help['Help']['slug']; ?>" target="_blank"><?php echo h($help['Help']['slug']); ?></a>&nbsp;</td>
						<td><?php echo $this->Html->link($help['User']['firstname'],
					 ...
					 array('class'=>'btn btn-default','escape' => false,
					  'data-title'=>__('edit').' '.$help['Help']['name'],'data-toggle'=>'tooltip','data-placement'=>'bottom')); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Html->link('<span class="icon-trash"></span>','#delete'.$help['Help']['id'],
