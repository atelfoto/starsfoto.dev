...
<div class="portfolios index col-md-12" id="portfolio">
	<div class="page-header ">
		<h2><i class="icon-picture">&nbsp;</i><?php echo __('portfolio manager'); ?></h2>
	</div>
	...
	<div class="text-right " style='margin-bottom:10px;'>
		...
		<?php echo $this->Html->link("<i class='icon-plus'></i>". __("Add portfolio"),array('action'=>'add'),
		...
		<table  class="table table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php  echo $this->Time->format($portfolio['Portfolio']['created'], '%A %e %B, %Y'); ?>&nbsp;</td>
					<td><?php  echo $this->Time->format($portfolio['Portfolio']['modified'], '%A %e %B, %Y'); ?>&nbsp;</td>
					...
					<td class="actions">
						<?php echo $this->Html->link('<span class="icon-edit" style="color:#00f;"></span>',
					...
					<td>
						...
						<?php echo $this->Html->link('<span class="icon-trash" style="color:#f00;"></span>','#Modal'.$portfolio['Portfolio']['id'],
						array(
