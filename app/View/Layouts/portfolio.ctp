<?php  $cakeDescription = __d('cake_dev', 'Château de Chazeron Site Officiel '); ?><!DOCTYPE html>
<html lang="fr">
<head>
...
<!-- <link rel="apple-touch-icon" href="http://www.chateau-chazeron.com/img/apple-icon.png"/> -->
...
<link rel="apple-touch-startup-image" href="http://www.chateau-chazeron.com/img/apple-image.png"/> -->
<?php
...
<meta name="twitter:site" content="stars foto">
<meta name="twitter:creator" content="stars foto">
<meta name="twitter:domain" content="<?= env('HTTP_HOST');?>">
<meta name="application-name" content="stars foto"/>
...
<div class="" style="margin-left:50px;color:#fff;" id='page-header'>
